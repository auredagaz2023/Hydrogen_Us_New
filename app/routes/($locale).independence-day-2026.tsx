...
import dolcevitapng from '../assets/independence-day-2026/Desktop/Products/Images/01-dolce-vita.jpg'
import dolcevitapng_roll from '../assets/independence-day-2026/Desktop/Products/Roll/01-dolce-vita-roll.jpg'
import mobileDolcevitapng from '../assets/independence-day-2026/Mobile/Products/01-dolce-vita.jpg'

import magnicoolpng from '../assets/independence-day-2026/Desktop/Products/Images/02-magnicool.jpg'
import magnicoolpng_roll from '../assets/independence-day-2026/Desktop/Products/Roll/02-magnicool-roll.jpg'
import mobileMagnicoolpng from '../assets/independence-day-2026/Mobile/Products/02-magnicool.jpg'

import magnistretchpng from '../assets/independence-day-2026/Desktop/Products/Images/03-magnistretch.jpg'
import magnistretchpng_roll from '../assets/independence-day-2026/Desktop/Products/Roll/03-magnistretch-roll.jpg'
import mobileMagnistretchpng from '../assets/independence-day-2026/Mobile/Products/03-magnistretch.jpg'

import magnificopng from '../assets/independence-day-2026/Desktop/Products/Images/04-magnifico.jpg'
import magnificopng_roll from '../assets/independence-day-2026/Desktop/Products/Roll/04-magnifico-roll.jpg'
import mobileMagnificopng from '../assets/independence-day-2026/Mobile/Products/04-magnifico.jpg'

import classicopng from '../assets/independence-day-2026/Desktop/Products/Images/05-classico.jpg'
import classicopng_roll from '../assets/independence-day-2026/Desktop/Products/Roll/05-classico-roll.jpg'
import mobileClassicopng from '../assets/independence-day-2026/Mobile/Products/05-classico.jpg'

import pillowspng from '../assets/independence-day-2026/Desktop/Products/Images/06-pillows.jpg'
import pillowspng_roll from '../assets/independence-day-2026/Desktop/Products/Roll/06-pillows-roll.jpg'
import mobilePillowspng from '../assets/independence-day-2026/Mobile/Products/06-pillows.jpg'


export const handle = {
  seo: {
    title: 'Independence Day 2026 - Magniflex Collections',
    titleTemplate:
      'Independence Day 2026 - Magniflex Collections',
    description:
      ...
      <div className="px-3 sm:container py-16 md:py-24 lg:py-28" style={{ lineHeight: 1.5 }}>
        <div className='bg-white text-[#174860] landing-[29px] text-[17.5px] text-center pb-[64px] md:pb-[32px] px-[30px] md:px-[20%]'>
          <div style={{ marginBottom: '25px' }}>
            <span className='font-bold'>True freedom starts with a fully recharged body</span><br /><br />
            Break free from restless nights and create your ultimate sleep sanctuary with <span className='font-bold text-[#ED1C24]'>30% off premium mattresses and pillows</span>. Experience the luxury of authentic Italian comfort built around your well-being and <span className='font-bold text-[#ED1C24]'>save up to $3,959</span>.
          </div>
        </div>
