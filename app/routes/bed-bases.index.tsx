...
export const handle = {
  seo: {
    title: 'Explore the Ultimate Bed Bases from Magniflex | Magniflex',
    titleTemplate: 'Explore the Ultimate Bed Bases from Magniflex | Magniflex',
    description:
      "Explore our range of bed bases designed for the perfect sleep foundation. Shop Magniflex's high-quality bed bases to enhance your sleep experience and support your mattress effectively.",
    handle: '@shopify',
    url: `https://magniflex.us/beds-bases`,
  },
};
