...
import pillowspng from '../assets/memorial-day-2026/Desktop/Products/Images/06-pillows.jpg'
import pillowspng_roll from '../assets/memorial-day-2026/Desktop/Products/Roll/06-pillows-roll.jpg'
import mobilePillowspng from '../assets/memorial-day-2026/Mobile/Products/06-pillows.jpg'


export const handle = {
  seo: {
    title: 'Memorial Day Promo 2026 - Magniflex Collections',
    titleTemplate:
      'Memorial Day Promo 2026 - Magniflex Collections',
    description:
...
export default function MemorialDayPromo2026() {
