...
export const handle = {
  seo: {
    title: 'Beat the Heat 2026 - Magniflex Collections',
    titleTemplate:
      'Beat the Heat 2026 - Magniflex Collections',
    description:
      ...
      <div className="px-3 sm:container py-16 md:py-24 lg:py-28" style={{ lineHeight: 1.5 }}>
        <div className='bg-white text-[#174860] text-center pb-[64px] md:pb-[32px] px-[30px] md:px-[8%]'>
          <div className='mb-[25px]'>
            <div className='text-[28px] md:text-[41px] leading-tight font-bold mb-[20px]'>
              Ready for the coolest summer sleep?
            </div>
            <div className='text-[26px] md:text-[39px] leading-tight font-bold mb-[32px]'>
