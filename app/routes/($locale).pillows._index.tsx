...
export const handle = {
  seo: {
    title: 'Shop Magniflex Premium Pillows | Magniflex | Magniflex',
    titleTemplate: 'Shop Magniflex Premium Pillows | Magniflex | Magniflex',
    description:
    ...
    handle: '@shopify',
    url: `https://magniflex.us/pillows`,
  },
};
  ...
  return (
    <>
      ...
      <div className="px-3 sm:container py-6 md:pt-16 md:pb-28">
        <CollectionHeading heading="Pillows" />
