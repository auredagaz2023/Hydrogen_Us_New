...
export const handle = {
  seo: {
    title: 'Shop Magniflex Premium Mattress Toppers | Magniflex',
    titleTemplate: 'Shop Magniflex Premium Mattress Toppers | Magniflex',
    description:
      'Elevate your sleep with a Magniflex topper: soft or firm support, thermoregulatory, and breathable materials for a cool and dry rest.',
    handle: '@shopify',
    url: `https://magniflex.us/toppers`,
  },
};
