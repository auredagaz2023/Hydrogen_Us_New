                ...
                {productType == 'Mattress' && (
                  <>
                    <div
                      ...
                      className={`flex grow justify-between items-center p-2 md:px-4 md:py-5 break-all text-174860 text-10 md:text-xs font-semibold uppercase border border-border cursor-pointer ${
