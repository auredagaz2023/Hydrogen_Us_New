...
export default function CategoryCollections() {
  ...
  const sortProductsByType = (products: ProductType[]): ProductType[] => {
    ...
    _products = [
      ..._products,
      ...products.filter(
        (product: ProductType) => product.productType === 'Mattress',
      ),
    ];
    _products = [
      ..._products,
      ...products.filter(
        (product: ProductType) => product.productType === 'Pillow',
      ),
    ];
    _products = [
      ..._products,
      ...products.filter(
        (product: ProductType) => product.productType === 'Beds and Bases',
      ),
    ];
    _products = [
      ..._products,
      ...products.filter(
        (product: ProductType) => product.productType === 'Topper',
      ),
    ];
    return _products;
  };
