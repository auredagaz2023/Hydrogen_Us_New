...
export default function Sostenibilita(props: {keyframe: Keyframes}) {
  ...
  return (
    <>
      <Section
        padding="x"
        className="justify-center bg-[url('../assets/Brand/bg-sustainable.jpg')] bg-center bg-cover text-white h-banner max-h-banner min-h-banner items-center center lg:pl-0 lg:pr-0 text-center"
      >
      ...
      <section className="py-16 lg:py-32">
        <Fade duration={1000} triggerOnce>
          ...
          <div className="px-3 sm:container flex flex-wrap justify-between text-174860 mt-20">
