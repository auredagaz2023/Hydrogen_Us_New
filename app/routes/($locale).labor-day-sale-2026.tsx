...
import desktopHeader from '../assets/labor-day-sale-2026/Desktop/Header/magniflex-us-labor-day-snooze-a-thon-sale-header-desktop.jpg'
import desktopHeaderBottom from '../assets/labor-day-promo-2025/header/magniflex-landing-benefit-bar.gif'
import mobileHeader from '../assets/labor-day-sale-2026/Mobile/Header/magniflex-us-labor-day-snooze-a-thon-sale-header-mobile.jpg'
import mobileHeaderBottom from '../assets/labor-day-promo-2025/header/magniflex-landing-benefit-bar-mobile-A.gif'
import dolcevitapng from '../assets/labor-day-sale-2026/Desktop/Products/Images/01-dolce-vita.jpg'
import dolcevitapng_roll from '../assets/labor-day-sale-2026/Desktop/Products/Roll/01-dolce-vita-roll.jpg'
import mobileDolcevitapng from '../assets/labor-day-sale-2026/Mobile/Products/01-dolce-vita.jpg'

import magnicoolpng from '../assets/labor-day-sale-2026/Desktop/Products/Images/02-magnicool.jpg'
import magnicoolpng_roll from '../assets/labor-day-sale-2026/Desktop/Products/Roll/02-magnicool-roll.jpg'
import mobileMagnicoolpng from '../assets/labor-day-sale-2026/Mobile/Products/02-magnicool.jpg'

import magnistretchpng from '../assets/labor-day-sale-2026/Desktop/Products/Images/03-magnistretch.jpg'
import magnistretchpng_roll from '../assets/labor-day-sale-2026/Desktop/Products/Roll/03-magnistretch-roll.jpg'
import mobileMagnistretchpng from '../assets/labor-day-sale-2026/Mobile/Products/03-magnistretch.jpg'

import magnificopng from '../assets/labor-day-sale-2026/Desktop/Products/Images/04-magnifico.jpg'
import magnificopng_roll from '../assets/labor-day-sale-2026/Desktop/Products/Roll/04-magnifico-roll.jpg'
import mobileMagnificopng from '../assets/labor-day-sale-2026/Mobile/Products/04-magnifico.jpg'

import classicopng from '../assets/labor-day-sale-2026/Desktop/Products/Images/05-classico.jpg'
import classicopng_roll from '../assets/labor-day-sale-2026/Desktop/Products/Roll/05-classico-roll.jpg'
import mobileClassicopng from '../assets/labor-day-sale-2026/Mobile/Products/05-classico.jpg'

import pillowspng from '../assets/labor-day-sale-2026/Desktop/Products/Images/06-pillows.jpg'
import pillowspng_roll from '../assets/labor-day-sale-2026/Desktop/Products/Roll/06-pillows-roll.jpg'
import mobilePillowspng from '../assets/labor-day-sale-2026/Mobile/Products/06-pillows.jpg'


export const handle = {
  seo: {
    title: 'Labor Day Sale 2026 - Magniflex Collections',
    titleTemplate:
      'Labor Day Sale 2026 - Magniflex Collections',
    description:
...
const products = [
  ...
  //   name: "Classico",
  //   description: "The perfect combination of performance and essentiality for a mattress with a built-in massaging system designed to meet every sleep need.",
...
const Classico = {
  ...
  name: "Classico",
  description: "The perfect combination of performance and essentiality for a mattress with a built-in massaging system designed to meet every sleep need.",
  bestfor: "quality sleep lovers, restorative sleep seekers",
  fitness: "medium-firm",
  fitnessLabel: "Benefits:",
  original_price: "$1,979",
  price: "$1,386",
  button: "Shop Classico",
  link: "https://magniflex.us/mattresses/classico?product=classico-essential-10",
  bottom: "Save up to $1,319",
  mattress: true
}
...
export default function LaborDaySale2026() {
      ...
      <div className="px-3 sm:container py-16 md:py-24 lg:py-28" style={{ lineHeight: 1.5 }}>
        <div className='bg-white text-[#174860] landing-[29px] text-[17.5px] text-center pb-[64px] md:pb-[32px] px-[30px] md:px-[20%]'>
          <div style={{ marginBottom: '25px' }}>
            <span className='font-bold'>Peak performance starts with deeper, more restorative sleep</span><br /><br />
            Upgrade your daily recovery this Labor Day with <span className='font-bold text-[#ED1C24]'>30% off select mattresses and pillows</span>. Experience the unparalleled comfort and support of authentic Italian design and engineering, and <span className='font-bold text-[#ED1C24]'>save up to $4,355</span> on your ultimate sleep system.
          </div>
        </div>
                ...
                <div key={index} className='px-[32px] md:px-12 pb-32 relative'>
                  ...
                  <div className='flex flex-col items-center px-0 md:px-12'>
                    ...
                    <div className='mt-[30px] lg:mt-[25px] text-[17px] lg:text-[15px] md:text-center w-full'>
                      ...
                      <br />
                      <span className='text-[#839BB1]'>{product.fitnessLabel ?? 'Firmness:'}</span> <span className='text-[#174860] text-[15px]'>{product.fitness}</span>
                    </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 mb-[70px]'>
          {[Classico, Pillows].map((product: any, index) => {
            const hoverIndex = index + products.length;

            return (
              <div key={product.name} className='px-[32px] md:px-12 pb-32 relative'>
                <div className='relative h-auto'>
                  <img
                    src={product.roll_img}
                    onMouseOver={() => handleHover(hoverIndex)}
                    onMouseOut={handleUnhover}
                    alt="product_img"
                    className='hidden md:block absolute'
                    style={{
                      objectFit: 'cover',
                      opacity: hoveredIndex === hoverIndex ? 1 : 0,
                      transition: 'opacity 0.5s ease'
                    }}
                  />
                  <img
                ...
                <div className='flex flex-col items-center px-0 md:px-12'>
                  ...
                  <div className='mt-[30px] lg:mt-[25px] text-[17px] lg:text-[15px] md:text-center w-full'>
                    ...
                    <br />
                    <span className='text-[#839BB1]'>{product.fitnessLabel ?? (product.name === 'MAGNIFLEX PILLOWS' ? 'Benefits:' : 'Firmness:')}</span> <span className='text-[#174860] text-[15px]'>{product.fitness}</span>
                  </div>
                  <div className='mt-[25px] text-[#839BB1] text-[13px] landing-[27.5px] text-center'>
                    Starting at{' '}
                    <br className='hidden md:block' />
        ...
        <div
          className='flex flex-col mt-4 px-[30px] lg:p-4 pt-[40px] lg:pt-0 bg-[#F6F6F6] relative left-1/2'
          style={{ marginLeft: '-50vw', marginRight: '-50vw', width: '100vw' }}
        >
          ...
          <div className='px-12 lg:mt-[40px] mt-[208px] w-full flex justify-center hidden lg:block'>
          ...
          <div className='lg:hidden w-full text-[16px] my-[40px] mt-[80px] sm:text-[20px] md:text-[24px] lg:text-[30px] text-center landing-[100px] font-semibold py-[30px] lg:py-0 pt-[53px] md:pt-[80px] relative'>
